...
class Colors: NSObject {
  ...
  //  rgba(0, 34, 231, 1)./
    //rgba(253, 106, 0, 1)
  //  rgba(220, 3, 142, 1)
    static let PINK_COLOR  =   UIColor(red: 253/255, green: 106/255, blue:0/255, alpha: 1)
    static let ORANGE_COLOR =  UIColor(red: 220/255, green: 3/255, blue: 142/255, alpha: 1)
